...
class GameTheoryDebateState(TypedDict):
    smart_money_history: Annotated[str, "Smart money analyst conversation history"]
    retail_history: Annotated[str, "Retail investor analyst conversation history"]
    history: Annotated[str, "Overall GT conversation history"]
    current_speaker: Annotated[str, "Speaker that spoke last"]
    current_response: Annotated[str, "Latest response"]
    count: Annotated[int, "Length of the GT conversation"]
    claims: Annotated[list[dict[str, Any]], "Tracked GT claims (intent vs perception)"]
    focus_claim_ids: Annotated[list[str], "GT claim ids that must be answered next"]
    open_claim_ids: Annotated[list[str], "GT claim ids still open"]
    resolved_claim_ids: Annotated[list[str], "GT claim ids considered resolved"]
    unresolved_claim_ids: Annotated[list[str], "GT claim ids still materially disputed"]
    round_summary: Annotated[str, "Summary of the latest GT debate round"]
    round_goal: Annotated[str, "Current GT round objective"]
    claim_counter: Annotated[int, "Claim counter for unique ids"]
...
class AgentState(MessagesState):
    ...
    game_theory_debate_state: Annotated[
        GameTheoryDebateState, "State of the debate between Smart Money and Retail"
    ]
    ...
    portfolio_report: Annotated[str, "Final report from the Portfolio Manager"]
    allocation_details: Annotated[dict[str, Any], "Structured allocation details from the Portfolio Manager"]
