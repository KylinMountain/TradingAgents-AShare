...
def _fetch_all(ticker: str, trade_date: str) -> Dict[str, Any]:
    ...
    return {
        ...
        # get_board_fund_flow takes no arguments
        "fund_flow_board": _safe(get_board_fund_flow, {}),
        "fund_flow_individual": _safe(get_individual_fund_flow, {"symbol": ticker}),
        "lhb": _safe(get_lhb_detail, {"symbol": ticker, "date": trade_date}),
        # get_insider_transactions takes only ticker
        "insider_transactions": _safe(get_insider_transactions, {"ticker": ticker}),
